...
vim.api.nvim_create_autocmd('FileType', {
    pattern = { "cs", "lua" }, -- Note that we have to use filetypes instead of globstyle pattern on FileType events.
    callback = function()
...
local function inner_setup(palette)
    ...
    local highlights = {
        ...
        ["@lsp.typemod.variable.defaultLibrary.lua"]      = { link = "Normal" },
        ...
        -- typescript
        ["@lsp.typemod.parameter.declaration.typescript"] = { link = "@lsp.type.variable" },
        ["@lsp.typemod.variable.declaration.typescript"]  = { link = "@lsp.type.variable" },
        ["@lsp.typemod.function.declaration.typescript"]  = { link = "Function" },
        ["typescriptBraces"]                              = { link = "Normal" },
        ["typescriptNull"]                                = { link = "Normal" },
        ["@lsp.typemod.member.declaration.typescript"]    = { link = "Function" },
        ["@lsp.type.function.typescript"]                 = { link = "Normal" },
        ["typescriptSpecial"]                             = {},

        -- javascript
        ["@lsp.mod.defaultLibrary.javascript"]            = { link = "Normal" },
        ["javaScriptBraces"]                              = { link = "Normal" },
        ["@lsp.type.function.javascript"]                 = { link = "Normal" },
        ["@lsp.typemod.parameter.declaration.javascript"] = { link = "@lsp.type.variable" },
        ["@lsp.typemod.variable.declaration.javascript"]  = { link = "@lsp.type.variable" },
