vim.pack.add({
    {
        ...
        version = "427e9222363d07c32d6db6169e4049c28d58d141",
    }
})
...
local function inner_setup(palette)
    ...
    local highlights = {
        ...
        ["javaScriptReserved"]                   = {},
        ["javaScriptNull"]                       = { link = "Normal" },
        ["javaScriptConditional"]                = { link = "Keyword" },
        ["javaScriptStatement"]                  = { link = "Keyword" },
        ["javaScriptBranch"]                     = { link = "Keyword" },
        ["javaScriptLabel"]                      = { link = "Keyword" },
